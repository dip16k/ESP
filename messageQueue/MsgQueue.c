...
/**	this utility funtion is used to send data in priority queue
	...
	send_msg funtion will fail if there is no space in message queue, if queue is FULL
...
/**	this utility funtion is used to receve data from the priority queue
	...
	recv_msg call will fail if there is no message in the queue 
	...
	@return		int 		FAIL on failure, SUCCESS on successfully recevied message
*/
